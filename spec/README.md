...
| [09-performance-architecture.md](09-performance-architecture.md) | §23.13 | 070-075 | Zero-copy cold start, sorted-array backend, permutation index fusion, homomorphic fingerprint, LIVE-first checkpoint |

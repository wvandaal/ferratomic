...
pub const CATALOG: &[Invariant] = &[
    ...
    Invariant {
        ...
        type_level: Some(
            "Snapshot owns SnapshotDatoms (Arc<PositionalStore> or OrdSet<Datom>) — no &mut accessor exists; datom set is frozen at capture time",
        ),
    },
    Invariant {
        id: "INV-FERR-007",
    ...
    Invariant {
        ...
        type_level: Some(
            "EntityId newtype with private inner field; production: from_content() (BLAKE3); crate-internal: from_trusted_bytes (WAL/checkpoint integrity-verified)",
        ),
    },
    // -----------------------------------------------------------------------
    ...
    Invariant {
        ...
        type_level: Some(
            "Store exposes only transact (add) and merge (union) — no remove/delete/mutate path exists in the API",
        ),
    },
    Invariant {
        id: "INV-FERR-019",
    ...
    Invariant {
        ...
        kani_harness: Some("null_anti_entropy_roundtrip"),
        stateright_model: None,
    ...
    Invariant {
        ...
        kani_harness: Some("substrate_agnosticism_in_memory"),
        stateright_model: None,
    ...
    Invariant {
        ...
        stage: Stage::Stage0,
        lean_theorem: Some("index_view_deterministic"),
        proptest_fn: Some("inv_ferr_025_backend_observational_equivalence"),
        kani_harness: Some("index_backend_order_independence"),
        stateright_model: None,
        integration_test: Some("test_inv_ferr_025_index_backend_trait"),
        type_level: Some(
            "GenericIndexes<B> keeps backend choice parametric behind one logical index API",
        ),
    },
    Invariant {
        id: "INV-FERR-026",
        ...
        kani_harness: Some("write_amplification_bound"),
        stateright_model: None,
    ...
    Invariant {
        ...
        kani_harness: Some("eavt_lookup_correctness"),
        stateright_model: None,
    ...
    Invariant {
        ...
        kani_harness: Some("cold_start_checkpoint_roundtrip"),
        stateright_model: None,
    ...
    Invariant {
        ...
        kani_harness: Some("positional_live_kernel_matches_latest_event_model"),
        stateright_model: None,
    ...
    Invariant {
        ...
        stage: Stage::Stage0,
        lean_theorem: Some("replica_subset"),
        proptest_fn: Some("inv_ferr_030_accept_all_filter"),
        kani_harness: Some("filter_subset_property"),
        stateright_model: None,
        integration_test: Some("test_inv_ferr_030_replica_filter"),
        type_level: Some(
            "ReplicaFilter restricts replica construction to predicate-based datom selection",
        ),
    },
    Invariant {
        id: "INV-FERR-031",
    ...
    Invariant {
        ...
        kani_harness: Some("select_latest_live_value_lww_semantics"),
        stateright_model: None,
    ...
    Invariant {
        ...
        stage: Stage::Stage1,
        lean_theorem: None,
        proptest_fn: Some("inv_ferr_059_positional_store_preserves_queries, inv_ferr_059_sorted_vec_indexes_preserves_queries, inv_ferr_059_checkpoint_v3_roundtrip_preserves_queries, inv_ferr_059_eytzinger_layout_preserves_search, inv_ferr_059_interpolation_search_preserves_lookups, inv_ferr_059_transact_demotion_preserves_datoms"),
        kani_harness: None,
        stateright_model: None,
        integration_test: Some("test_inv_ferr_059_isomorphism_api_shape, test_inv_ferr_059_isomorphism_detects_divergence"),
        type_level: None,
    },
    // -----------------------------------------------------------------------
